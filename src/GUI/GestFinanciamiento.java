 ...
 * @author Rafael Reyes
 */
public class GestFinanciamiento extends javax.swing.JFrame {

    /**
     * Creates new form GestFinanciamiento
     */
    public GestFinanciamiento() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Panel de Gestión Financimiento");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/404.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestFinanciamiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestFinanciamiento().setVisible(true);
            }
        });
    }
